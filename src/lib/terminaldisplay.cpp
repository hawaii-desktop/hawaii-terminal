...
// static
bool TerminalDisplay::kAntialiasingEnabled = true;
bool TerminalDisplay::kTransparencyEnabled = true;
...
void TerminalDisplay::drawBackground(QPainter &painter, const QRect &rect, const QColor &backgroundColor, bool useOpacitySetting)
{
    ...
    if (kTransparencyEnabled && qAlpha(_blendColor) < 0xff && useOpacitySetting) {
